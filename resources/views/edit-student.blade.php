...
<div class="container">
    ...
    <img class="mt-3" src="{{ asset('storage/') }}/{{ $student[0]->image }}" alt="" width="100" height="100" />
    <form class="mt-3" id="updateStudent" enctype=multipart/form-data>
        @csrf
        <input class="form-control mb-3" type="text" name="name" placeholder="Enter Name" value="{{ $student[0]->name }}"  />
        <input class="form-control mb-3" type="email" name="email" placeholder="Enter Email" value="{{ $student[0]->email }}" />
