                    ...
                    if(data.students.length > 0){
                        for(let i=0;i<data.students.length;i++){
                            ...
                            $('#students-table').append(`<tr>
                                ...
                                <td><img src="<?php echo e(asset('storage/`+img+`')); ?>" alt="`+img+`" width="60px" height="60px"/></td>
                                <td>
                                    <a href="<?php echo e(route('addStudent')); ?>" class="btn btn-sm btn-success">Add</a>
...
<?php /**PATH D:\learning\laravel\Programming Experience\Laravel CRUD Using AJAX (jQuery)\college\resources\views/student.blade.php ENDPATH**/ ?>